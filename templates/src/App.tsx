...
const initialCards = [
  ...
  // 3과목
  // [3과목] 빅데이터 모델링 (Big Data Modeling)
  {
    id: 38,
    title: "[3과목] 분석 모형의 오류",
    content: "Q: 분석 모형 정의 시 발생하는 주요 오류는?\nA: 과대적합(Overfitting: 너무 복잡함), 과소적합(Underfitting: 너무 단순함)."
  },
  {
    id: 39,
    title: "[3과목] 선형 회귀 4대 가정",
    content: "Q: 선형 회귀 분석의 4대 가정(선분정독)은?\nA: 선형성, 등분산성, 정상성(정규성), 독립성."
  },
  {
    id: 40,
    title: "[3과목] 다중공선성 판단",
    content: "Q: 다중공선성을 판단하는 지표와 기준은?\nA: VIF(분산팽창인수) 값이 10 이상이면 다중공선성이 존재한다고 판단."
  },
  {
    id: 41,
    title: "[3과목] 의사결정나무 분할 기준",
    content: "Q: 알고리즘별 분할 기준은?\nA: CHAID(카이제곱), CART(지니지수), C4.5/C5.0(엔트로피 지수)."
  },
  {
    id: 42,
    title: "[3과목] 활성화 함수 종류",
    content: "Q: 인공신경망 활성화 함수의 특징은?\nA: Sigmoid(0~1), ReLU(기울기 소실 방지), Softmax(다중 분류 출력층)."
  },
  {
    id: 43,
    title: "[3과목] 연관성 분석 지표",
    content: "Q: 연관성 분석의 3대 평가지표(지신향)는?\nA: 지지도(동시 포함), 신뢰도(조건부 확률), 향상도(1보다 크면 양의 상관관계)."
  },
  {
    id: 44,
    title: "[3과목] 시계열 분석 구성요소",
    content: "Q: 시계열 분석의 4가지 구성요소는?\nA: 추세 요인, 계절 요인, 순환 요인, 불규칙 요인."
  },
  {
    id: 45,
    title: "[3과목] 앙상블 분석 기법",
    content: "Q: 앙상블 분석의 주요 기법 4가지는?\nA: 보팅(투표), 배깅(랜덤 포레스트), 부스팅(가중치 부여), 스태킹(예측 결과 재학습)."
  },

  // 4과목
  {
    id: 46,
    title: "[4과목] 혼동행렬 주요 지표",
    content: "Q: 분류 모델의 주요 지표는?\nA: 정밀도(TP/(TP+FP)), 재현율(TP/(TP+FN)), F1-Score(정밀도와 재현율의 조화평균)."
  },
  {
    id: 47,
    title: "[4과목] ROC 커브와 AUC",
    content: "Q: ROC 커브와 AUC의 의미는?\nA: FPR(x축)과 TPR(y축)의 시각화이며, 면적(AUC)이 1에 가까울수록 성능이 우수함."
  },
  {
    id: 48,
    title: "[4과목] 군집 분석 품질 평가",
    content: "Q: 군집 분석의 평가 지표는?\nA: 실루엣 계수(1에 가까울수록 좋음), Elbow 기법(WCSS 경사가 완만해지는 K 선정)."
  },
  {
    id: 49,
    title: "[4과목] 과대적합 방지 규제",
    content: "Q: 라쏘(L1)와 릿지(L2) 규제의 차이는?\nA: 라쏘(절대값 합, 맨하탄 거리), 릿지(제곱합, 유클리디안 거리)."
  },
  {
    id: 50,
    title: "[4과목] 파라미터 vs 하이퍼파라미터",
    content: "Q: 두 개념의 결정적 차이는?\nA: 파라미터(모델 내부 자동 결정), 하이퍼파라미터(사용자가 수동 설정)."
  },
  {
    id: 51,
    title: "[4과목] 공간 시각화 기법",
    content: "Q: 주요 공간 시각화 기법 3가지는?\nA: 등치지역도(채도 활용), 카토그램(면적 왜곡), 버블 플롯 맵(버블 크기 활용)."
  },
  {
    id: 52,
    title: "[4과목] 인포그래픽 특징",
    content: "Q: 인포그래픽의 특징과 유형은?\nA: 정보+그래픽의 합성어, 설득 목적. (지도형, 도표형, 타임라인형 등 존재)."
  }
